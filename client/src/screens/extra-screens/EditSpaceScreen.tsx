...
export const EditSpaceScreen = ({navigation , route} : MainNavProps<"EditSpaceScreen">) => {
    ...
    const _updatePost = async () => {
        ...
        const response = await updateSpace({
            ...
            update: (cache) => updateAfterSpaceDetails(spaceId , spaceName , spaceDescription , cache)
        })
